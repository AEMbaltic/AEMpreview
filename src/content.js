...
export const scenes = [
  ...
  },
  {
    ...
    hscroll: {
      ...
      to: 0.97,
      items: [
        { num: '01', title: 'Performance marketing', emoji: '📈', body: 'Paid search & social that pays for itself.' },
        { num: '02', title: 'Social & content', emoji: '💬', body: 'Feeds people actually follow.' },
        { num: '03', title: 'SEO & data', emoji: '🔍', body: 'Found first, measured always.' },
        { num: '04', title: 'Brand campaigns', emoji: '📣', body: 'Stories that stick — from first scroll to final sale.' },
      ],
    },
  },
  {
